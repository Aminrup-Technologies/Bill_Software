<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactno.aspx.cs" Inherits="Bill_Software.corporate.business.app.Update.contactno" %>
...
<body>
   ...
   <div style="width: 500px; height: 300px">
    <table cellpadding="0" cellspacing="1" class="style1">
            ...
            <tr>
                <td class="style5" colspan="2">
                    <asp:Button ID="btnUpdate" class="btn_style" runat="server" Text="Update" onclientclick="return ValidateField();" onclick="btnUpdate_Click" />
                </td>
            </tr>
            <tr>
                <td>
