<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="password.aspx.cs" Inherits="Bill_Software.corporate.business.app.Update.password" %>
        ...
        <table cellpadding="0" cellspacing="1" class="style1">
            <tr>
                <td width="50%" class="style2" colspan="2">
                    <a href="../settings.aspx"onclick="opener.location='../settings.aspx';self. close();return false;">
            ...
            <tr>
                <td class="style2">
                    Enter Your Current Password : </td>
                <td>
                    &nbsp;<asp:TextBox ID="txtCrntPassword" runat="server" class="textbox_style" 
            ...
            <tr>
                ...
                <td>
                    &nbsp;<asp:TextBox ID="txtNewPassword" runat="server" class="textbox_style" 
                        TextMode="Password"></asp:TextBox>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                                        &nbsp;<asp:TextBox ID="txtConfNewPassword" runat="server"  TextMode="Password" class="textbox_style"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style5" colspan="2">
                    <asp:Button ID="btnUpdate" class="btn_style" runat="server" Text="Update" onclick="btnUpdate_Click" CausesValidation="true" ValidationGroup="grp1"/>
