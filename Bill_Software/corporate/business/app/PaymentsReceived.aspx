<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="PaymentsReceived.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm87" %>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:6%;">
                                     <asp:Label ID="Label23" runat="server" Text='<%# Eval("") %>'></asp:Label></td>
                                <td style="text-align:center; width:6%;">
