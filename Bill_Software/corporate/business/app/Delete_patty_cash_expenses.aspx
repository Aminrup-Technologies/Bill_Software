<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_patty_cash_expenses.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm58" %>
    ...
    <table cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style3"> Delete Patty Cash Expenses</span>&nbsp;</td>
        </tr>
        <tr>
            <td width="15%">
                &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center; width:8%;">
                                    <asp:ImageButton ID="ImageButton2" runat="server" 
                                        CommandArgument='<%# Eval("payment_id") %>' CommandName="Delete"  
