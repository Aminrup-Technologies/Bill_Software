...
namespace Bill_Software.corporate.business.app
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        public static double total_sail_rate_details = 0;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            lblvendor_id.Text = companyID.ToString();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (dt1 != null)
            {
                ...
                for (i = 0; i <= dt1.Rows.Count - 1; i++)
                {
                    ...
                    try
                    {
                        ...
                        string Vendor_rate = ((Label)gd_Service_Product.Rows[i].FindControl("Vendor_rate")).Text;
                        ...
                        total_sail_rate_details = total_sail_rate_details + Convert.ToDouble(total_sail_rate2);
                        cmd.CommandText = ("insert into tbl_purches_details(sl_no,Purches_id,Product_id,Product_name,vendor_rate,tax_applicable,tax_rate,Quantity,total_purches_rate,vat_amount,sail_rate,Service_tax_rate,Total_sail_rate,Total_sail_rate1,Total_sail_rate2,Client_id,Purches_date)values('" + j.ToString() + "','" + purchesid + "','" + Ser_pro_code + "','" + Ser_pro_Name + "','" + Vendor_rate + "','" + tax_app + "','" + vat_parsentage + "','" + Quantity + "','" + parches_rate111 + "','" + tax_rete + "','" + Sale_rate + "','" + service_Tax_Rate + "','" + total_sail_rate + "','" + total_sail_rate1 + "','" + total_sail_rate2 + "','" + lblvendor_id.Text + "','" + txtPurchesDate.Text + "')");
                        cmd.ExecuteNonQuery();
            ...
            DbCL.executeRdr("insert into tbl_Purches(Purches_Id,Client_Id,Total_purches_rate,Total_sail_rate,Purches_date)values('" + purchesid + "','" + lblvendor_id.Text + "','" + tota_purchesrate1 + "','" + total_sail_rate_details + "','" + txtPurchesDate.Text + "')");
