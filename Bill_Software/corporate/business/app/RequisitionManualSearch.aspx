<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="RequisitionManualSearch.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm73" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Search Requisition</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
        ...
        <tr>
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center">
                    ...
                    &nbsp;<asp:Button ID="btnreset" runat="server" CssClass="auto-style2" onclick="btnreset_Click" Text="Reset" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
