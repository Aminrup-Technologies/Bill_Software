<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="PaymentPhase.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm77" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateField() {
            if (document.getElementById('<%=txtPaymentPhase.ClientID%>').value == "") {
                alert("Provide Payment Phase.");
                document.getElementById('<%=txtPaymentPhase.ClientID%>').focus();
        return false;
    }
}
     ...
     <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style2">Manage Payment Phase</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="2" width="20%">
                <asp:TextBox ID="txtPaymentPhase" runat="server" CssClass="textbox_U_style"></asp:TextBox>
            </td>
            <td width="20%">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="showrm" runat="server" Text="Payment Phase"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="PrimaryService" runat="server" Text='<%# Eval("PaymentPhase") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
