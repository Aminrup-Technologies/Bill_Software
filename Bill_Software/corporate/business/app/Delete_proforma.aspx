<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_proforma.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm33" %>
...
<script type="text/javascript" language="javascript">
   ...
   <script type="text/javascript">
       function ValidateDelete1() {
           var answer = confirm("Want to Delete this Proforma Invoice?");
           if (!answer) {
               return false;
           }
       }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Proforma Invoice</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td colspan="4">
                <asp:Panel ID="PanelOK" runat="server" BorderColor="#006600" BorderStyle="Solid" BorderWidth="1px" Visible="False" BackColor="#EEFFDD">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                <td style="text-align:center; width:17%;">
                                    <asp:Label ID="Label6" runat="server" Text="Proforma No"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label3" runat="server" Text="Proforma Date"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:11%;">Rs.
                                ...
                                <td style="text-align:center; width:7%;">
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Invoice_No") %>' 
