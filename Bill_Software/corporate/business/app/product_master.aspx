<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="product_master.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm6" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:13%;">
                                    <asp:Label ID="Label5" runat="server" Text="Sub Product Name"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label6" runat="server" Text="Base Rate"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:13%;">
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("Sub_Prod_Name") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
