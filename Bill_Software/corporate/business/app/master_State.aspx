<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="master_State.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">&nbsp;<span class="style2">Manage State</span></td>
        </tr>
        <tr>
            <td width="20%">&nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td width="20%">&nbsp; Provide new State name</td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align: center; width: 70%;">
                                    <asp:Label ID="showrm" runat="server" Text="State"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align: center; width: 70%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("State_Name") %>'></asp:Label>
                                </td>
                                <td style="text-align: center; width: 10%;">
