<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Seartch_purchess_payments.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm48" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Search Purchese Payment</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
