<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="edit_purchaseorder.aspx.cs" Inherits="Bill_Software.corporate.business.app.edit_purchaseorder" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" class="auto-style1">
                <tr>
                    <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Edit Purchase Order (PO)</span></td>
                </tr>
                <tr>
                    <td width="15%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: center">
                        ...
                        &nbsp;<asp:Button ID="btnreset" runat="server" CssClass="btn_style" OnClick="btnreset_Click" CausesValidation="false" Text="Reset" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                            ...
                            <ItemTemplate>
                                ...
                                <td style="text-align:center; width:4%;">
                                   <asp:ImageButton ID="ImageButton2" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Quotation_no") %>' 
                                        ...
                                        <td style="text-align: center; width: 5%;">
                                            <a href="#" title="Print Quotation..." onclick="window.open('/corporate/business/print/NewPurchaseOrder.aspx?ID=<%# DataBinder.Eval (Container.DataItem,"ID")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
                                                <img alt="" height="25px" src="../WebImages/viewicon.png" /></a>
                                        </td>
                                        <td style="text-align: center; width: 4%;">
                                            <asp:ImageButton ID="ImageButton1" runat="server"
