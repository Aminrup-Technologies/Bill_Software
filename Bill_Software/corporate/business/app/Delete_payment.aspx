<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_payment.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm37" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Payment</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            ...
                            <td style="text-align:center; width:6%;">
                                ...
                                <td style="text-align:center; width:7%;">
                                    <asp:Label ID="Label14" runat="server" Text="Delete"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </HeaderTemplate>
