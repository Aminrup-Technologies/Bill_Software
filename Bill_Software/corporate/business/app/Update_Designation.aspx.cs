    ...
    public partial class WebForm81 : System.Web.UI.Page
    {
        ...
        private void BindDesignation(string empid)
        {
            ...
            if (dtuse.Rows.Count > 0)
            {
                ...
                Edit_Purches.Text = dtuse.Rows[0]["Edit_Purches"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (lblEmpId.Text != "")
            {
                ...
                SqlParameter[] pram = {
                    ...
                    new SqlParameter("@Edit_Purches",Edit_Purches.Text),
