<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="View_PurchaseOrder.aspx.cs" Inherits="Bill_Software.corporate.business.app.View_PurchaseOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="0" class="auto-style1">
        <tr>
            <td colspan="4" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;View Purchase Order Received from Customer (Last 30 Days)</span></td>
        </tr>
        <tr>
            <td width="10%">&nbsp;</td>
            <td width="40%">&nbsp;</td>
        ...
        <tr>
            <td colspan="4">
                <%--<asp:DataList ID="DataList1" runat="server" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" Font-Bold="False" Font-Size="11px" ForeColor="#2D2D2D" GridLines="Both" Width="100%" OnItemDataBound="DataList1_ItemDataBound" OnItemCommand="DataList1_ItemCommand">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                <td style="text-align: center; width: 3%;">
                                    <asp:Label ID="lblHeaderSlNo" runat="server" Text="Sl"></asp:Label>
                                </td>
                                ...
                                <td style="text-align: center; width: 7%;">
                                    <asp:Label ID="LabelPO" runat="server" Text="ARC Number"></asp:Label>
                                </td>
                                <td style="text-align: center; width: 7%;">
                                    <asp:Label ID="LabelDO" runat="server" Text="PO/ DO Number"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align: center; width: 7%;">
                                    <asp:Label ID="lblPO" runat="server" Text='<%# Eval("PO_Number") %>'></asp:Label>
                                </td>
                                <td style="text-align: center; width: 7%;">
                                    <asp:Label ID="lblDO" runat="server" Text='<%# Eval("DO_Number") %>'></asp:Label>
                                </td>
                                <td style="text-align: center; width: 13%;">
                                ...
                                <td style="text-align: center; width: 5%;">
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="View" CommandArgument='<%# Eval("ID") %>'
                                        ImageUrl="~/corporate/business/WebImages/viewicon.png" ToolTip="View" Width="22px" Height="22px" />
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
                ...
                <asp:DataList ID="DataList1" runat="server" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" Font-Size="11px" ForeColor="#2D2D2D" GridLines="Both" Width="100%" OnItemDataBound="DataList1_ItemDataBound" OnItemCommand="DataList1_ItemCommand">
                    <FooterStyle BackColor="White" ForeColor="#000066" />
                    <AlternatingItemStyle BackColor="#94B8FF" />
                    <SeparatorStyle BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" />
                    <SelectedItemStyle BackColor="#669999" Font-Bold="True" ForeColor="White" />
                    ...
                    <HeaderTemplate>
                        <table class="table1" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <th style="text-align: center; width: 16%;">Quotation Info</th>
                        ...
                        <table class="table2" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="text-align: center; width: 16%;">
                                    <asp:Label ID="LabelQuotationNo" runat="server" Text='<%# Eval("Quotation_no") %>' Font-Bold="true" Font-Size="Small"></asp:Label><br />
                                ...
                                <td style="text-align: center; width: 15%;">
                                    ...
                                    <span>Tax:</span> Rs.<asp:Label ID="LabelGST" runat="server" Text='<%# Eval("service_tax1") %>'></asp:Label><br />
                                ...
                                <td style="text-align: center; width: 10%;">
                                    <asp:Label ID="LabelAddedBy" runat="server" Text='<%# Eval("AddedByName") %>'></asp:Label><br />on<br />
                                    <asp:Label ID="LabelTimestamp" runat="server" Text='<%# Convert.ToDateTime(Eval("TimsStamp")).ToString("dd-MMM-yyyy hh:mm tt") %>' />
                                </td>
