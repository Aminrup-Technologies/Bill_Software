<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Expenses_Head.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm42" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateDelete1() {
            var answer = confirm("Want to Delete this Expenses Head?");
            if (!answer) {
                return false;
            }
        }
     ...
     <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style2">Manage Expenses Head</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td width="20%">
                &nbsp;
                Provide new Expenses Head name</td>
            <td colspan="2" width="20%">
                <asp:TextBox ID="txtCityName" runat="server" CssClass="textbox_U_style"></asp:TextBox>
            </td>
            <td width="20%">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="showrm" runat="server" Text="Expenses Head"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("Expencess_Name") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
