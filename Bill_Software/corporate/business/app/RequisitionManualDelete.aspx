<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="RequisitionManualDelete.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm74" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Requisition</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:20%;"><a href="#" onclick='window.open(&#039;/corporate/business/print/RequisitionNew.aspx?ReqNo=<%# DataBinder.Eval (Container.DataItem,"ReqNo")%>&#039;, &#039;popupwindow&#039;,&#039;width=900px,height=800px,scrollbars=yes&#039;);return true' title="Print Requisition...">
                                    <img alt="" height="25px" src="../WebImages/viewicon.png" />
                                    </a>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("ReqNo") %>' 
