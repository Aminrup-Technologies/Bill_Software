                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-right" style="line-height: 1.4;">
                                    ...
                                    <span class="badge badge-tax"><%# Eval("cgstOrsgst").ToString() == "YES" ? "CGST/SGST" : (Eval("igst").ToString() == "YES" ? "IGST" : "TAX") %></span> ₹<%# Eval("Gst") %><br />
                                    <span style="color: #666;">Freight:</span> ₹<%# Eval("Delivery_Amount") %><br />
                                    <span style="color: #666;">Other:</span> ₹<%# Eval("otherAmount1") %><br />
                                    <strong style="color: #28a745; font-size: 13px;">Total: ₹<%# Eval("Net_Amount") %></strong></td>
                                <td>
