<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Service_update.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm55" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateField() {
            ...
            if (document.getElementById('<%=txtPurchesRate.ClientID%>').value == "") {
                alert("Provide Purches Rate.");
                document.getElementById('<%=txtPurchesRate.ClientID%>').focus();
                return false;
            }
    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="4">
                &nbsp;<span class="style2"> Service Update</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td>
                &nbsp;Purches Rate&nbsp;</td>
            <td>
                <asp:TextBox ID="txtPurchesRate" runat="server" CssClass="textbox_U_style" onkeypress="return validate(event)" Enabled="False"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
