<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Viewhydrent_invoice.aspx.cs" Inherits="Bill_Software.corporate.business.app.Viewhydrent_invoice" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                               ...
                               <%-- <td style="text-align:center; width:5%;">
                                ...
                                <td style="text-align:center; width:7%;">
                                    <a href = "#" title="Print Invoice..." onclick="window.open('/corporate/business/print/hydrentInvoiceSeller.aspx?ID=<%# DataBinder.Eval (Container.DataItem,"ID")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
                                                <img alt="" height="25px" src="../WebImages/viewicon.png" />
                                </td>
                            </tr>
                        </table>
