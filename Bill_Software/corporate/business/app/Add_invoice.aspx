                ...
                <asp:GridView ID="Gridview_Product" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E8F3FF" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="Grid" ForeColor="Black" style="margin-left: 0px; font-size: 11px; font-family: Arial, Helvetica, sans-serif; text-align: center;" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox6" runat="server" checked="true" Enabled="false"></asp:TextBox>
                                                </EditItemTemplate>

                                                <HeaderTemplate>
                                                     <asp:CheckBox ID="checkAll" runat="server" checked="true" Enabled="false" onclick = "checkAll(this);" />
                                                </HeaderTemplate>

                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chk" runat="server" checked="true" Enabled="false" onclick = "Check_Click(this)" />
                                                </ItemTemplate>
                                                <HeaderStyle Width="3%" />
                                                <ItemStyle Width="3%" />
                                            </asp:TemplateField>
            ...
            <td colspan="4">
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:ListBox ID="FactoryAddress" runat="server" AutoPostBack="True" BackColor="#6699ff" BorderStyle="Solid" BorderWidth="1px" Font-Size="10px" multiple="true" Rows="3" SelectionMode="Multiple" Width="550px"></asp:ListBox>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
