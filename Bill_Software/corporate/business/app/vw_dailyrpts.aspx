...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function validateSalesVisitForm() {
            ...
            let errorMsg = '';
            if (visitDate === '') errorMsg += '• Visit Date and Time is required.\n';
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="style1" style="margin-top: 20px;">
                ...
                <tr>
                    <td style="width: 2%">&nbsp;</td>
                    <td width="15%"><span class="style3">*</span>Visit Date & Time</td>
                    <td width="30%">
                        <asp:TextBox ID="txtVisitDate" runat="server" TextMode="DateTimeLocal" CssClass="textbox_style" Width="90%"></asp:TextBox>
                    </td>
                    <td style="width: 2%">&nbsp;</td>
