<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="delete_purchaseorder.aspx.cs" Inherits="Bill_Software.corporate.business.app.delete_purchaseorder" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" class="auto-style1">
                <tr>
                    <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Purchase Order(PO)</span></td>
                </tr>
                <tr>
                    <td width="15%">&nbsp;</td>
                            ...
                            <ItemTemplate>
                                <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                                    ...
                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("Net_amount") %>'></asp:Label>
                                        ...
                                        <td style="text-align: center; width: 5%;">
                                            <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" CommandName="View" CommandArgument='<%# Eval("ID") %>'
                                                ImageUrl="~/corporate/business/WebImages/viewicon.png" ToolTip="View" />
                                        </td>

                                        <td style="text-align: center; width: 4%;">
                                            <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="false" CommandName="Delete" CommandArgument='<%# Eval("Quotation_no") %>'
                                                ImageUrl="~/corporate/business/WebImages/delete.png" ToolTip="Delete" OnClientClick="return ValidateDelete1();" />
                                        </td>
