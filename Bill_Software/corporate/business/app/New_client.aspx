...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">&nbsp;<span class="style2">Create Client</span>&nbsp;</td>
        </tr>
        <tr>
            <td width="10%">&nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td width="15%">&nbsp;<span class="style3">*</span>Client Name&nbsp;</td>
            <td width="25%">
                <asp:TextBox ID="txtvendorName" runat="server" CssClass="textbox_style"
                    Width="250px"></asp:TextBox>
            </td>
            <td width="15%" class="auto-style1" colspan="2">
                <asp:Label ID="lbl_nxtclientid" runat="server" Text="AD01" Font-Bold="true"></asp:Label></td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td width="15%">&nbsp;<span class="style3">*</span>Corporate Office Address&nbsp;</td>
            <td width="25%">
        ...
        <tr>
            <td>&nbsp;</td>
            <td width="15%">&nbsp;<span class="style3">*</span>Phone Number</td>
            <td width="25%">
        ...
        <tr>
            <td>&nbsp;</td>
            <td width="15%">&nbsp;Registered Office Address&nbsp;</td>
            <td width="25%">
