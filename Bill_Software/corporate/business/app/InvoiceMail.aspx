<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="InvoiceMail.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm83" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label19" runat="server" Text="Invoice Date"></asp:Label>
                                </td>
                                ...
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="edit0" runat="server" Text="Buyer's View"></asp:Label>
                                </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">Rs.
                                    ...
                                    /- </td>
                                 <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("status2") %>'></asp:Label>
                                    /- </td>
