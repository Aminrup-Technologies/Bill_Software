<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_chalan.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm41" %>
...
<script type="text/javascript" language="javascript">
    ...
    <script type="text/javascript">
        function ValidateDelete1() {
            var answer = confirm("Want to Delete this Challan?");
            if (!answer) {
                return false;
            }
        }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete DPCC (Delivery planning cum Challan)</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
        ...
        <tr>
            <td colspan="6">
                <asp:DataList ID="DataList2" runat="server" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" Font-Bold="False" Font-Size="11px" ForeColor="#2D2D2D" GridLines="Both" Width="100%" OnItemCommand="DataList2_ItemCommand">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:20%;">
                                 ...
                                 <td style="text-align:center; width:20%;">
                                    <asp:Label ID="Label8" runat="server" Text="Product Catagory"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center; width:20%;">
                                 ...
                                 <td style="text-align:center; width:20%;">
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("PServiceName") %>'></asp:Label>
                                </td>
                                
                                
                                <td style="text-align:center; width:10%;">
                                    
                                    <%--<a href = "#" title="Print Challan..." onclick="window.open('/corporate/business/print/chhalan.aspx?Chalan_No=<%# DataBinder.Eval (Container.DataItem,"Chalan_No")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
                                ...
                                <td style="text-align:center; width:10%;">
                                    ...
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Chalan_No") %>' 
