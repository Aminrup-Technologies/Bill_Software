<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Seartch_proforma.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm32" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Search Proforma Invoice</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label9" runat="server" Text="Mail Date"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">Rs.
                                    ...
                                    /- </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("mail_Date") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
