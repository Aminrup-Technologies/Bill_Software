<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Update_vendor.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td bgcolor="#19658A" colspan="6">
            &nbsp;<span class="style2">Update Vendor for <asp:Label ID="lblvendor_id" runat="server"></asp:Label></span>&nbsp;</td>
    </tr>
    <tr>
        <td width="10%">
            &nbsp;</td>
