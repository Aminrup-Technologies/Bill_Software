<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Service_master.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm7" %>
...
<script type="text/javascript">
    function ValidateDelete1() {
        var answer = confirm("Want to Delete this Service?");
        if (!answer) {
            return false;
        }
    }
    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="4">
                &nbsp;<span class="style2">Service Products</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                Provide new Service name</td>
            <td>
                <asp:TextBox ID="txtServiceName" runat="server" CssClass="textbox_U_style"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:15%;">
                                    <asp:Label ID="Label1" runat="server" Text="Service Code"></asp:Label>
                                </td>
                                <td style="text-align:center; width:27%;">
                                    <asp:Label ID="showrm" runat="server" Text="Service Name"></asp:Label>
                                </td>
                                <%--<td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label6" runat="server" Text="Purches Rate"></asp:Label>
                                </td>--%>
                                 <td style="text-align:center; width:12%;">
                                    <asp:Label ID="Label8" runat="server" Text="Base Rate"></asp:Label>
                                </td>
                                <td style="text-align:center; width:12%;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                <td style="text-align:center; width:10%;">
                                 ...
                                 <td style="text-align:center; width:15%;">
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("Service_code") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:27%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("Service_name") %>'></asp:Label>
                                </td>
                                <%--<td style="text-align:center; width:10%;">
                                ...
                                <td style="text-align:center; width:12%;">
                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("Tax_rate") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:12%;">
