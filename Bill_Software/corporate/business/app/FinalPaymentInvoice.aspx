<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="FinalPaymentInvoice.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm86" %>
                            ...
                            <td style="text-align:center; width:6%;">
                              ...
                              <%--  <td style="text-align:center; width:8%;">
                                ...
                                <td style="text-align:center; width:8%;">
                                 ...
                                 <td style="text-align:center; width:6%;">
                                    <asp:Label ID="Label23" runat="server" Text="INVOICE AMOUNT WITH GST(INR)"></asp:Label>
                                </td>
                                 <td style="text-align:center; width:6%;">
                                ...
                                <td style="text-align:center; width:6%;">
                                    <asp:Label ID="Label28" runat="server" Text="LAST MAILER DATE"></asp:Label>
                                </td>
                                <td style="text-align:center; width:6%;">
                                    <asp:Label ID="Label1" runat="server" Text="Buyers View"></asp:Label>
                                </td>
