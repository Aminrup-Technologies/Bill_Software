<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="view_expencess_head.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm44" %>
    ...
    <table cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style3"> View General Expenses</span>&nbsp;</td>
        </tr>
        <tr>
            <td width="15%">
                &nbsp;</td>
                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label3" runat="server" Text="Instrument No"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:12%;">Rs.
                                ...
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("chk_dd_no") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:20%;">
