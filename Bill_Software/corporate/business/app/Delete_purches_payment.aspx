<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_purches_payment.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm49" %>
...
<script type="text/javascript" language="javascript">
   ...
   <script type="text/javascript">
       function ValidateDelete1() {
           var answer = confirm("Want to Delete this Payment?");
           if (!answer) {
               return false;
           }
       }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Purchese Payment</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            ...
                            <td style="text-align:center; width:8%;">
                                ...
                                <td style="text-align:center; width:7%;">
                                    <asp:Label ID="Label14" runat="server" Text="View"></asp:Label>
                                </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            ...
                            <td style="text-align:center; width:8%;">
                                ...
                                <td style="text-align:center; width:7%;">
                                    ...
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Payment_ID") %>' 
