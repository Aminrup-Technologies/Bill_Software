<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="add_payment.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm34" %>
...
<script type="text/javascript">
    ...
    <table cellpadding="0" cellspacing="0" class="auto-style1">
        <tr>
            <td colspan="6" bgcolor="#19658A"><span class="style2">&nbsp;Add Payment</span>>&nbsp;</td>
        </tr>
        <tr>
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="style148">
                            &nbsp;&nbsp;</td>
                        <td class="style149">
                            <asp:Label ID="lblcurrancy" runat="server" Visible="False"></asp:Label>
                            <asp:Label ID="lblpayment_id" runat="server" Visible="False"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:0" class="auto-style3"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" onselectedindexchanged="RadioButtonList2_SelectedIndexChanged" RepeatDirection="Horizontal">
                                ...
                                <asp:ListItem>Online Fund Transfer</asp:ListItem>
                            </asp:RadioButtonList>
                            &nbsp; </td>
                        <td>
                            <asp:Label ID="lblcurrancy1" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
...
&nbsp;</div>
                            ...
                            <div style="width:100%;" id="Third" runat="server" visible="false">
                                Transaction Reference Number: <asp:TextBox ID="txtneftnumber" runat="server" 
                     ...
                     <tr>
                        ...
                        <td class="style153" style="size=10%">
                            &nbsp;TDS Deducted By Client&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            TDS Amount (Rs)&nbsp;</td>
                        <td>
                            <asp:TextBox ID="txtrate" runat="server" Height="22px" Width="200px"></asp:TextBox>
                            <asp:DropDownList ID="cmbtdsvalue" runat="server" Visible="False" Height="16px" 
                                Width="80px">
                            </asp:DropDownList>
                            <asp:RadioButtonList ID="rdoCalculationType" runat="server" 
                                RepeatDirection="Horizontal" Visible="False" Height="26px">
                                <asp:ListItem Selected="True">TDS Forward Calculation</asp:ListItem>
                                <asp:ListItem>TDS Backword Calculation</asp:ListItem>
                            </asp:RadioButtonList>
                            <asp:TextBox ID="txttdsamount" runat="server" Visible="True" OnTextChanged="txttdsamount_TextChanged">0</asp:TextBox>
                        </td>
                     </tr>
                    <tr>
