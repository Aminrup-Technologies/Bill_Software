<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Block_invoice.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm64" %>
...
<script type="text/javascript" language="javascript">
   ...
   <script type="text/javascript">
       function ValidateDelete1() {
           var answer = confirm("Want to Block this Invoice?");
           if (!answer) {
               return false;
           }
       }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Block Invoice</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:7%;">
                                    <asp:Label ID="Label9" runat="server" Text="Block"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </HeaderTemplate>
                               ...
                               <%-- <td style="text-align:center; width:7%;">
                                ...
                                <td style="text-align:center; width:7%;">
                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Invoice_No") %>' 
                                        ImageUrl="~/corporate/business/WebImages/block.png" ToolTip="Delete" onclientclick="return ValidateDelete1();"/>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
