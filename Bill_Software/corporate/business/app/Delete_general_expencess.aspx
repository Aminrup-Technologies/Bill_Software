<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_general_expencess.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm45" %>
...
<script type="text/javascript" language="javascript">
	...
	<script type="text/javascript">
	    function ValidateDelete1() {
	        var answer = confirm("Want to Delete The Expenses?");
	        if (!answer) {
	            return false;
	        }
	    }
    ...
    <table cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style3"> Delete General Expenses</span>&nbsp;</td>
        </tr>
        <tr>
            <td width="15%">
                &nbsp;</td>
        ...
        <tr>
            <td width="15%">
                &nbsp;</td>
            <td class="style5" colspan="4" width="35%">
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                    ...
                    <asp:ListItem>Expenses &amp; Date</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="style4" colspan="4">
                <asp:Button ID="btnSertch" runat="server" CssClass="btn_style" 
                    onclick="btnSertch_Click" Text="Search"/>
                ...
                <asp:DataList ID="DataList1" runat="server" BorderColor="#666666" 
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                <td style="text-align:center; width:12%;">
                                    <asp:Label ID="ID" runat="server" Text='<%# Eval("pament_made_id") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("pament_made_date") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:19%;">
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("expencess_head") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:11%;">Rs.
                                    <asp:Label ID="Label7" runat="server" Text='<%# Eval("amount") %>'></asp:Label> /-
                                </td>
                                <td style="text-align:center; width:12%;">
                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("pament_made_mode") %>'></asp:Label>
                                </td>
                                
                                <td style="text-align:center; width:20%;">
                                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("pament_made_to") %>'></asp:Label>
                                </td>
                                
                                <td style="text-align:center; width:8%;">
                                    <a href = "#" title="Print Voutcher..." onclick="window.open('/corporate/business/print/General_expencess_voutcher.aspx?pament_made_id=<%# DataBinder.Eval (Container.DataItem,"pament_made_id")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
                                                <img alt="" height="25px" src="../WebImages/viewicon.png" /></a>
                                </td>
                                <td style="text-align:center; width:8%;">
                                    <asp:ImageButton ID="ImageButton2" runat="server" 
                                        CommandArgument='<%# Eval("pament_made_id") %>' CommandName="Delete"  
                                        ImageUrl="~/corporate/business/WebImages/delete.png" 
                                         onclientclick="return ValidateDelete1();" ToolTip="Delete"  />
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
