                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="edit" runat="server" Text="Original Copy for Consignee"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label1" runat="server" Text="Duplicate Copy for Transporter"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label8" runat="server" Text="Triplicate Copy for Consignor"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </HeaderTemplate>
