<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="View_payment.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm35" %>
     ...
     <table cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td bgcolor="#19658A" colspan="4">
                &nbsp;<span class="style3"> View Payment</span>&nbsp;</td>
        </tr>
        <tr>
            <td width="10%">
                &nbsp;</td>
