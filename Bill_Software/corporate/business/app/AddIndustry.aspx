<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="AddIndustry.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm75" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateField() {
            if (document.getElementById('<%=txtInductry.ClientID%>').value == "") {
                alert("Provide Industry Name.");
                document.getElementById('<%=txtInductry.ClientID%>').focus();
        return false;
    }
}
...
<script type="text/javascript">
    function ValidateDelete1() {
        var answer = confirm("Want to Delete this Industry?");
        if (!answer) {
            return false;
        }
    }
    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style2">Manage Industry</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="2" width="20%">
                <asp:TextBox ID="txtInductry" runat="server" CssClass="textbox_U_style"></asp:TextBox>
            </td>
            <td width="20%">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="showrm" runat="server" Text="Industry Name"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="IndustryName" runat="server" Text='<%# Eval("IndustryName") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
