    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="4">
                &nbsp;<span class="style2">Update Menu Control</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr><td>&nbsp;</td><td colspan="2" style="text-align:center">
            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn_style" OnClick="btnSave_Click"/><asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn_style" OnClick="btnReset_Click"/></td><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td><td></td><td>
            &nbsp;</td><td>&nbsp;</td></tr>
    </table>
</asp:Content>
