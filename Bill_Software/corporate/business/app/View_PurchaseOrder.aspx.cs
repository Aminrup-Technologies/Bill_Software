...
namespace Bill_Software.corporate.business.app
{
    public partial class View_PurchaseOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //string cmdstring = "select tbl_QuoPriSerTogather.PServiceName, tbl_Quotation.ID, tbl_Quotation.service_tax1, tbl_Quotation.sub_total, tbl_Quotation.Quotation_no,tbl_Quotation.Quotation_date, tbl_Quotation.Gross, tbl_Quotation.Service_tax, tbl_Quotation.Net_amount, tbl_Quotation.cgstOrsgst, tbl_Client.Client_Name, tbl_Quotation.PO_Number, tbl_Quotation.DO_Number from tbl_Quotation LEFT OUTER join tbl_Client on tbl_Quotation.Client_Id=tbl_Client.Client_Id LEFT OUTER JOIN tbl_QuoPriSerTogather on tbl_QuoPriSerTogather.qutno = tbl_Quotation.Quotation_no and tbl_QuoPriSerTogather.TimeStamp = tbl_Quotation.TimsStamp where tbl_Quotation.RecordType!='Quotation' order by CAST(tbl_Quotation.Quotation_date as datetime) desc";

                string cmdstring = "SELECT tbl_QuoPriSerTogather.PServiceName, tbl_Quotation.Client_Id, tbl_Quotation.ID, tbl_Quotation.service_tax1, tbl_Quotation.sub_total, tbl_Quotation.Quotation_no, tbl_Quotation.Quotation_date, tbl_Quotation.Gross, tbl_Quotation.Service_tax, tbl_Quotation.Net_amount, tbl_Quotation.cgstOrsgst, tbl_Client.Client_Name, tbl_Quotation.PO_Number, tbl_Quotation.DO_Number, tbl_Quotation.Validity_StartDate, tbl_Quotation.Validity_EndDate, tbl_Quotation.AddedById, tbl_Quotation.TimsStamp, tbl_login.Name AS AddedByName FROM tbl_Quotation LEFT OUTER JOIN tbl_Client ON tbl_Quotation.Client_Id = tbl_Client.Client_Id LEFT OUTER JOIN tbl_QuoPriSerTogather ON tbl_QuoPriSerTogather.qutno = tbl_Quotation.Quotation_no AND tbl_QuoPriSerTogather.TimeStamp = tbl_Quotation.TimsStamp LEFT OUTER JOIN tbl_login ON tbl_login.User_Id = tbl_Quotation.AddedById WHERE tbl_Quotation.RecordType != 'Quotation' ORDER BY CAST(tbl_Quotation.Quotation_date AS datetime) DESC";
