<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="ProformaMail.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm84" %>
...
function checkAll(objRef)
{
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Proforma Mail</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                ...
                <%--<asp:DataList ID="DataList1" runat="server" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px" Font-Bold="False" Font-Size="11px" ForeColor="#2D2D2D" GridLines="Both" Width="100%" OnItemCommand="DataList1_ItemCommand">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                <td style="text-align:center; width:17%;">
                                    <asp:Label ID="Label18" runat="server" Text="Proforma No"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label19" runat="server" Text="Proforma Date"></asp:Label>
                                </td>
                                ...
                                <td style="text-align:center; width:20%;">
                                    <asp:Label ID="Label20" runat="server" Text="Client Name"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label1" runat="server" Text="Invoice Amount"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="edit0" runat="server" Text="View"></asp:Label>
                                </td>
                                 <td style="text-align:center; width:5%;">
                                    <asp:Label ID="Label9" runat="server" Text="Select"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                <td style="text-align:center; width:17%;">
                                    <asp:Label ID="Label21" runat="server" Text='<%# Eval("Invoice_No") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label22" runat="server" Text='<%# Eval("Invoice_Date") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:18%;">
                                ...
                                <td style="text-align:center; width:20%;">
                                    <asp:Label ID="Label23" runat="server" Text='<%# Eval("Client_Name") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">Rs.
                                    <asp:Label ID="Label24" runat="server" Text='<%# Eval("Net_Amount") %>'></asp:Label>
                                    /- </td>
                                <td style="text-align:center; width:10%;"><a href="#" onclick='window.open(&#039;/corporate/business/print/proforma_invoice.aspx?ID=<%# DataBinder.Eval (Container.DataItem,"ID")%>&#039;, &#039;popupwindow&#039;,&#039;width=900px,height=800px,scrollbars=yes&#039;);return true' title="Print Proforma...">
                    ...
                    <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;"> 
                                    <asp:Label ID="Label6" runat="server" Text="PROFORMA INVOICE NUMBER"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label3" runat="server" Text="PROFORMA INVOICE DATE"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                ...
                                <td style="text-align:center; width:8%;">
                                    <asp:Label ID="Label9" runat="server" Text="AMOUNT BEFORE GST (INR)"></asp:Label>
                                </td>
                                <td style="text-align:center; width:8%;">
                                    <asp:Label ID="Label10" runat="server" Text="GST (INR)"></asp:Label>
                                </td>
                                ...
                                <td style="text-align:center; width:8%;"> 
                                 ...
                                 <td style="text-align:center; width:5%;"> 
                                    <asp:Label ID="Label15" runat="server" Text="LAST MAILER DATE"></asp:Label>
                                </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">
                                 ...
                                 <td style="text-align:center; width:10%;">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("PServiceName") %>'></asp:Label>
                                </td>
                                 <td style="text-align:center; width:8%;">
                                    <asp:Label ID="Label13" runat="server" Text='<%# Eval("subtotal") %>'></asp:Label>
                                </td>
                                 <td style="text-align:center; width:8%;">
                                    <asp:Label ID="Label14" runat="server" Text='<%# Eval("Gst") %>'></asp:Label>
                                </td>
                                ...
                                <td style="text-align:center; width:5%;">
                                    <asp:Label ID="Label16" runat="server" Text='<%# Eval("mail_Date") %>'></asp:Label>
                                </td>

                                <td style="text-align:center; width:5%;">
                                    <a href = "#" title="Print Proforma..." onclick="window.open('/corporate/business/print/NewProformaInvoice.aspx?ID=<%# DataBinder.Eval (Container.DataItem,"ID")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
        ...
        <tr>
            <td>&nbsp;</td>
            <td colspan="4" style="text-align:center;">
                <asp:Button ID="BtnSendMail" runat="server" CssClass="btn_style" Text="Send Mail" OnClick="BtnSendMail_Click"/>
