<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_purtches.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm22" %>
...
<script type="text/javascript">
    function ValidateDelete1() {
        var answer = confirm("Want to Delete this Purchasse?");
        if (!answer) {
            return false;
        }
    }
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Purchase</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem>Only Vendor</asp:ListItem>
                        <asp:ListItem Selected="True">Only Date</asp:ListItem>
                        <asp:ListItem>Vendor &amp; Date</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
                <td>&nbsp;</td>
            </tr>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:18%;">Rs. 
                                ...
                                <td style="text-align:center; width:7%;">
                                     <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Purches_Id") %>' 
