<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="hydrent_invoice.aspx.cs" Inherits="Bill_Software.corporate.business.app.hydrent_invoice" %>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:15%;">
                                    <asp:Label ID="addshowname0" runat="server" Text='<%# Eval("Q_date") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:30%;">
            ...
            <td colspan="4">
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDiscount" runat="server" CssClass="textbox_style" onkeypress="return validate(event)"></asp:TextBox>
                        </td>
                        <td>Address For</td>
                        <td>
