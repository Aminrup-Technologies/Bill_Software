                ...
                <asp:GridView ID="gd_Service_Product" runat="server" AutoGenerateColumns="False" CssClass="Grid" Width="100%" ShowFooter="true" OnRowCommand="gd_Service_Product_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SL" HeaderStyle-Width="3%">
                            <ItemTemplate>
                                <asp:TextBox ID="txtOrder" runat="server" Width="30px" CssClass="center textbox_style sl-input" ReadOnly="true" /></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Item No" HeaderStyle-Width="4%">
                            <ItemTemplate>
                                <asp:TextBox ID="ItemNo" runat="server" CssClass="textbox_style" Width="90%" Text='<%# Bind("ItemNo") %>'></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mat. No" HeaderStyle-Width="4%">
                            <ItemTemplate>
                                <asp:TextBox ID="MaterialNo" runat="server" CssClass="textbox_style" Width="90%" Text='<%# Bind("MaterialNo") %>'></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Pack" HeaderStyle-Width="4%">
                            <ItemTemplate>
                                <asp:TextBox ID="PackSize" runat="server" CssClass="textbox_style" Width="90%" Text='<%# Bind("PackSize") %>'></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Rate" HeaderStyle-Width="7%">
                            <ItemTemplate>
                                <asp:TextBox ID="Sail_Rate" runat="server" Text='<%# Bind("Sail_Rate") %>' CssClass="center textbox_style rate-input" Width="90%" onkeyup="calculateCart()" onchange="calculateCart()"></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="6%">
                            <ItemTemplate>
                                <asp:TextBox ID="Quantity" runat="server" Text='<%# Bind("Quantity") %>' CssClass="center textbox_style qty-input" Width="90%" onkeyup="calculateCart()" onchange="calculateCart()"></asp:TextBox></ItemTemplate>
                            <FooterTemplate><span id="ftr-qty">0</span></FooterTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Disc %" HeaderStyle-Width="5%">
                            <ItemTemplate>
                                <asp:TextBox ID="Discount_Rate" runat="server" Text='<%# Bind("Discount_Rate") %>' CssClass="center textbox_style disc-input" Width="90%" onkeyup="calculateCart()" onchange="calculateCart()"></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="GST %" HeaderStyle-Width="4%">
                            <ItemTemplate>
                                <asp:Label ID="Tax_Rate" runat="server" Text='<%# Bind("Tax_Rate") %>' CssClass="tax-lbl"></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Remarks" HeaderStyle-Width="10%">
                            <ItemTemplate>
                                <asp:TextBox ID="ItemRemarks" runat="server" CssClass="textbox_style" Width="90%" Text='<%# Bind("ItemRemarks") %>'></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Delivery Date" Visible="false">
                            <ItemTemplate>
                                <asp:TextBox ID="DeliveryDate" runat="server" CssClass="datepicker textbox_style" Text='<%# Bind("DeliveryDate") %>'></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Dept" Visible="false">
                            <ItemTemplate>
                                <asp:TextBox ID="Department" runat="server" CssClass="textbox_style" Text='<%# Bind("Department") %>'></asp:TextBox></ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
