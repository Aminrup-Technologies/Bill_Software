                                        ...
                                        <asp:TemplateField HeaderText="Input %(VAT/SERVICE TAX)">
                                            <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Base Rate (RS)">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="Sail_Rate" runat="server" Text='<%# Bind("Sail_Rate") %>' BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Width="80%" CssClass="center" Height="22px" onkeypress="return validate(event)"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Discount (%)">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="Discount_Rate" runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" Text="0" CssClass="center" Height="22px" Width="80%" onkeypress="return validate(event)"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Quantity">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="Quantity" runat="server" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px" CssClass="center" Height="22px" Width="80%" onkeypress="return validate(event)"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
