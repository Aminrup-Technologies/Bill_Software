<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Vat_master.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm9" %>
...
<script type="text/javascript">
    function ValidateDelete1() {
        var answer = confirm("Want to Delete this VAT?");
        if (!answer) {
            return false;
        }
    }
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("Vat_Rate") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
