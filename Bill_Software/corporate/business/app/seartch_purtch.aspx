<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="seartch_purtch.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm21" %>
...
<script type="text/javascript" language="javascript">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Search Purchasse</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                <td style="text-align:center; width:15%;">
                                    <asp:Label ID="showid" runat="server" Text="Purchasse ID"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                                    <asp:Label ID="showrm" runat="server" Text="Purchasse Date"></asp:Label>
                                </td>
                                <td style="text-align:center; width:25%;">
                                    <asp:Label ID="Label2" runat="server" Text="Vendor Name"></asp:Label>
                                </td>
                                <td style="text-align:center; width:20%;"> 
                                    <asp:Label ID="Label6" runat="server" Text="Total Purchasse Rate"></asp:Label>
                                </td>
                                <td style="text-align:center; width:20%;">
