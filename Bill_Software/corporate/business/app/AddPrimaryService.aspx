<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="AddPrimaryService.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm76" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateField() {
            if (document.getElementById('<%=txtPrimaryService.ClientID%>').value == "") {
                alert("Provide Primary Service.");
                document.getElementById('<%=txtPrimaryService.ClientID%>').focus();
        return false;
    }
}
    ...
    <script type="text/javascript">
     function ValidateDelete1() {
        var answer = confirm("Want to Delete this State?");
        if (!answer) {
            return false;
        }
    }
    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style2">Manage Primary Service</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="2" width="20%">
                <asp:TextBox ID="txtPrimaryService" runat="server" CssClass="textbox_U_style"></asp:TextBox>
            </td>
            <td width="20%">
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:70%;">
                                    <asp:Label ID="PrimaryService" runat="server" Text='<%# Eval("PrimaryService") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
