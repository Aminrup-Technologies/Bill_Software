<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Delete_vendor.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm14" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateDelete1() {
            var answer = confirm("Want to Delete this Vendor?");
            if (!answer) {
                return false;
            }
        }
    ...
    <table cellpadding="0" cellspacing="0" class="auto-style1">
        <tr>
            <td colspan="4" bgcolor="#19658A">
                &nbsp;<span class="style2">Delete Vendor</span>&nbsp;
            </td>
        </tr>
                <tr>
        <td width="15%">
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:20%;">
                                    <asp:ImageButton ID="ImageButton3" runat="server" CommandArgument='<%# Eval("Vendor_Id") %>' CommandName="Delete" ImageUrl="~/corporate/business/WebImages/delete.png" ToolTip="Delete" onclientclick="return ValidateDelete1();"/>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
