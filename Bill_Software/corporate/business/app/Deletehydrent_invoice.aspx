<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="Deletehydrent_invoice.aspx.cs" Inherits="Bill_Software.corporate.business.app.Deletehydrent_invoice" %>
...
<script type="text/javascript" language="javascript">
   ...
   <script type="text/javascript">
       function ValidateDelete1() {
           var answer = confirm("Want to Delete this Invoice?");
           if (!answer) {
               return false;
           }
       }
    ...
    <ContentTemplate>
      <table cellpadding="0" cellspacing="0" class="auto-style1">
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Invoice</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:11%;">Rs.
                                    ...
                                    /- </td>
                                <td style="text-align:center; width:7%;">
                                    <a href = "#" title="Print Invoice..." onclick="window.open('/corporate/business/print/Invoice.aspx?ID=<%# DataBinder.Eval (Container.DataItem,"ID")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
