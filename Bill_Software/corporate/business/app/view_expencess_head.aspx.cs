...
{
    public partial class WebForm44 : SecurePage
    {
        protected override string RequiredPermissionKey { get { return "view_expencess_head"; } }
        ...
        {
            Response.Redirect("~/corporate/business/app/view_expencess_head.aspx");
        }
    }
}