<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="master_city.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ValidateDelete1() {
            var answer = confirm("Want to Delete this City?");
            if (!answer) {
                return false;
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">&nbsp;<span class="style2">Manage City</span></td>
        </tr>
        <tr>
            <td width="20%">&nbsp;</td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align: center; width: 70%;">
                                    <asp:Label ID="showrm" runat="server" Text="City"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align: center; width: 70%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("City_Name") %>'></asp:Label>
                                </td>
                                <td style="text-align: center; width: 10%;">
