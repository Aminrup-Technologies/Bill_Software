<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="DeleteHydrentQuatation.aspx.cs" Inherits="Bill_Software.corporate.business.app.DeleteHydrentQuatation" %>
...
<script type="text/javascript">
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="6" bgcolor="#19658A">&nbsp;<span class="style2">&nbsp;Delete Quotation</span></td>
        </tr>
        <tr>
            <td width="15%">&nbsp;</td>
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:10%;">
                                    <a href = "#" title="Print Quotation..." onclick="window.open('/corporate/business/print/Quotation.aspx?ID=<%# DataBinder.Eval (Container.DataItem,"ID")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
                                                <img alt="" height="25px" src="../WebImages/viewicon.png" /></a>
                                </td>
                                <td style="text-align:center; width:10%;">
                                   <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Quotation_no") %>' 
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:15%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("Q_date") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:35%;">
                               ...
                               <%-- <td style="text-align:center; width:20%;">Rs. 
                                ...
                                <td style="text-align:center; width:10%;">
                                     <a href = "#" title="Print Quotation..." onclick="window.open('/corporate/business/print/QuotationHydrent.aspx?Quotation_no=<%# DataBinder.Eval (Container.DataItem,"Quotation_no")%>', 'popupwindow','width=900px,height=800px,scrollbars=yes');return true">
                                                <img alt="" height="25px" src="../WebImages/viewicon.png" /></a>
                                </td>
