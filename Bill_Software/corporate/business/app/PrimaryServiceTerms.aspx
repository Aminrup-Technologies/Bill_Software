<%@ Page Title="" Language="C#" MasterPageFile="~/corporate/business/app/Bill.Master" AutoEventWireup="true" CodeBehind="PrimaryServiceTerms.aspx.cs" Inherits="Bill_Software.corporate.business.app.WebForm78" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateField() {
             if (document.getElementById('<%=ddlPrimaryService.ClientID%>').selectedIndex == 0) {
                alert("Please Select City.");
                document.getElementById('<%=ddlPrimaryService.ClientID%>').focus();
                return false;
            }
            if (document.getElementById('<%=txtPrimaryServiceTerms.ClientID%>').value == "") {
                alert("Provide Service Terms.");
                document.getElementById('<%=txtPrimaryServiceTerms.ClientID%>').focus();
        return false;
    }
}
...
<script type="text/javascript">
    function ValidateDelete1() {
        var answer = confirm("Want to Delete this Item?");
        if (!answer) {
            return false;
        }
    }
     ...
     <table cellpadding="0" cellspacing="1" class="style1">
        <tr>
            <td bgcolor="#19658A" colspan="6">
                &nbsp;<span class="style2">Manage PrimaryService Terms</span></td>
        </tr>
        <tr>
            <td width="20%">
                &nbsp;</td>
        ...
        <tr>
         ...
         <tr>
            <td>
                &nbsp;</td>
            <td colspan="2">
                Primary Service Name</td>
            <td colspan="2">
                <asp:DropDownList ID="ddlPrimaryService" runat="server" CssClass="textbox_U_style" Width="200px"></asp:DropDownList>
                <%--<asp:TextBox ID="txtStateName" runat="server" CssClass="textbox_U_style"></asp:TextBox>--%>
             </td>
            <td>
                &nbsp;</td>
        </tr>
         ...
         <tr>
            <td>
                &nbsp;</td>
            <td colspan="2">
                Primary Service Terms</td>
            <td colspan="2">
                <asp:TextBox ID="txtPrimaryServiceTerms" runat="server" TextMode="MultiLine" CssClass="textbox_U_style" Width="200px"></asp:TextBox>
             </td>
            <td>
                &nbsp;</td>
        </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:30%;">
                                    <asp:Label ID="showrm" runat="server" Text="Primary Service"></asp:Label>
                                </td>
                                <td style="text-align:center; width:50%;">
                                    <asp:Label ID="Label1" runat="server" Text="Primary Service Terms"></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
                    ...
                    <ItemTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="table2" width="100%">
                            <tr>
                                ...
                                <td style="text-align:center; width:30%;">
                                    <asp:Label ID="addshowname" runat="server" Text='<%# Eval("PrimaryService") %>'></asp:Label>
                                </td>
                                 <td style="text-align:center; width:50%;">
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("PrimaryServiceTerms") %>'></asp:Label>
                                </td>
                                <td style="text-align:center; width:10%;">
