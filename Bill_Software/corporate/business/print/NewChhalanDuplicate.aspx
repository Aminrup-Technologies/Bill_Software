<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewChhalanDuplicate.aspx.cs" Inherits="Bill_Software.corporate.business.print.NewChhalanDuplicate" %>
                ...
                <tr>
                    <td id="bodycontain" width="100%" style="font-weight: bold">
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <td class="sub" style="text-align: right; font-weight: bold; font-size: 30px; color: #e31e24;">DUPLICATE CHALLAN</td>
                            </tr>
                            <tr class="trheight">
                               <td class="sub" style="text-align: right; font-weight: bold;  font-size: 15px;">Duplicate Copy for Transporter</td>
                            </tr>
                            <tr>
