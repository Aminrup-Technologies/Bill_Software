<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chhalan.aspx.cs" Inherits="Bill_Software.corporate.business.print.chhalan" %>
...
<body>
   ...
   <div id="printable" style="width:844px;">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
            ...
            <tr>
                <td class="style5" colspan="2">
                    <span lang="en-us"><span class="style6">&nbsp;</span><span class="style9">CHALLAN</span></span></td>
            </tr>
            <tr>
                <td colspan="2">
                    &nbsp;</td>
            ...
            <tr>
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" class="tableOne">
                        <tr>
                            <td style="width:50%">
                                Challan No:<span lang="en-us"> </span><asp:Label ID="lblchallan_no" runat="server"></asp:Label>
                            </td>
                            <td style="text-align:right; width:50%; padding:0px 5px 0px 0px;">
                                <span lang="en-us">&nbsp;</span>Challan Date:<span lang="en-us"> </span>
                                <asp:Label ID="lblchallan_date" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:50%">
                            ...
                            <td style="text-align:right; width:50%; padding:0px 5px 0px 0px;">
                                <span lang="en-us">&nbsp;</span>Quotation Date:<span lang="en-us"> </span>
                                <asp:Label ID="lblQdate" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <%--<tr>
                            <td style="width:50%">
                    ...
                    <asp:DataList ID="DataList1" runat="server" Width="100%" >
                     <HeaderTemplate>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1">
                                <tr>
                                        <td style="width:15%;text-align:center;"><asp:Label runat="server" ID="tupe_ofcirtificate" Text="S.No." Font-Bold="true" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label></td>
                                        <td style="width:65%;text-align:center;"><asp:Label runat="server" ID="no_of_sur" Text="PARTICULARS" Font-Bold="true" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label></td>
                                        <td style="width:20%;text-align:center;"><asp:Label runat="server" ID="Label4" Text="QUANTITY" Font-Bold="true" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label></td>
                        ...
                        <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table1">
                            <tr>
                                <td style="width:15%;border-top:none; text-align:center;"><asp:Label ID="qtation_survice" runat="server" Text='<%# Eval("Sl_no") %>' style="font-family: Arial; font-size: small;"></asp:Label></td>
                                <td style="width:65%;border-top:none; text-align:left; padding:0px 2px 0px 15px;"><asp:Label ID="survice_month" runat="server" Text='<%# Eval("Product_name") %>' style="font-family: Arial; font-size: small;"></asp:Label></td>
                                <td style="width:20%;border-top:none; text-align:center;"><asp:Label ID="Label5" runat="server" Text='<%# Eval("Quantity") %>' style="font-family: Arial; font-size: small;"></asp:Label></td>
                    ...
                    <%--<table cellpadding="0" cellspacing="0" width="100%";>
                            <tr>
                                ...
                                <td width="30%" style="text-align:right; padding:5px 20px 5px 0;" 
                                    ...
                                    &nbsp;</td>
                                <td width="15%" 
                                    style=" border-right:1px solid #bfbfbf; border-left:1px solid #bfbfbf; border-bottom:1px solid #bfbfbf;text-align:right; padding:0px 20px 0px 2px;" 
                                    class="style7">
                                    <asp:Label ID="lblSubtotal" runat="server" CssClass="style17"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:right; padding:5px 20px 5px 0;">
                                    ...
                                    <span class="style10"><span class="style18">Round off(+-&nbsp;<asp:Label ID="lblstax" runat="server"></asp:Label>
                ...
                <td colspan="2">
                    <%--<table width="100%" cellpadding="0" cellspacing="0" class="tableTwo">
                        <tr>
                            <td style="width:50%">
                                A/C Name:
                                <asp:Label ID="lblcompantfullname3" runat="server"></asp:Label>
                            </td>
                            <td style="width:50%;">
                        ...
                        <tr>
                            <td style="width:50%">
                                Branch:
                                <asp:Label ID="lblbrantch" runat="server"></asp:Label>
                            </td>
                            <td style="width:50%;">
                                IFSC Code:
