<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchess_payment.aspx.cs" Inherits="Bill_Software.corporate.business.print.purchess_payment" %>
...
<body>
    ...
    <div id="printable" style="width:844px;">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
            ...
            <tr>
                <td class="style5" colspan="2">
                    <span lang="en-us"><span class="style6">&nbsp;</span><span class="style9">PURCHASSE PAYMENT</span></span></td>
            </tr>
            <tr>
                <td colspan="2">
                    &nbsp;</td>
                ...
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" class="tableOne">
                        ...
                        <tr>
                            <td style="width:50%">
                                Payment ID:
                                <asp:Label ID="lblpayment_id" runat="server"></asp:Label>
                            </td>
                            <td style="text-align:right; width:50%; padding:0px 5px 0px 0px;">
                                Payment Date: <asp:Label ID="lblpayment_date" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td colspan="2">&nbsp; <strong>Total Payments:-<asp:Label ID="lblPayment_amount" runat="server"></asp:Label>
                    </strong>&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2">
                    ...
                    </table>--%>&nbsp; <strong>Total Due:-<asp:Label ID="lbldue" runat="server"></asp:Label>
                    </strong>
                    </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    &nbsp; <strong class="auto-style3">Payment Delails</strong>&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:DataList ID="DataList10" runat="server">
                        ...
                        <table>
                            <tr>
                                <td style="font-family: Arial; font-size: small;"><asp:Label ID="Label1000" runat="server" Text="Rs. " ></asp:Label></td>
                                <td style="font-family: Arial; font-size: small;"><asp:Label ID="Label100" runat="server" Text='<%# Eval("Given_Amount") %> '></asp:Label></td>
                                <td style="font-family: Arial; font-size: small;"><asp:Label ID="Label9" runat="server" Text=","></asp:Label></td>
                                <td style="font-family: Arial; font-size: small;"><asp:Label ID="Label200" runat="server" Text='<%# Eval("type") %> '></asp:Label></td> 
                                     
                                <td style="font-family: Arial; font-size: small;"><asp:Label ID="Label300" runat="server" Text='<%# Eval("Ch_no") %>'></asp:Label></td>
				 <td style="font-family: Arial; font-size: small;"><asp:Label ID="Label400" runat="server" Text='<%# Eval("Ch_date") %>'></asp:Label></td>
