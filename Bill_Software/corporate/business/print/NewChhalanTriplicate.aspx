<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewChhalanTriplicate.aspx.cs" Inherits="Bill_Software.corporate.business.print.NewChhalanTriplicate" %>
                ...
                <tr>
                    <td id="bodycontain" width="100%" style="font-weight: bold">
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr class="trheight">
                               <td class="sub" style="text-align: right; font-weight: bold;  font-size: 15px;">Triplicate Copy for Consignor</td>
                            </tr>
                            <tr>
