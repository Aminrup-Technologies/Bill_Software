<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPaymentInvoice.aspx.cs" Inherits="Bill_Software.corporate.business.print.NewPaymentInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tax Invoice Page</title>
                ...
                <tr>
                    <td id="bodycontain" width="100%" style="font-weight: bold">
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <td class="sub" style="text-align: right; font-weight: bold; font-size: 30px; font-family: Arial, Helvetica, sans-serif; color: #e31e24;">PAYMENT INVOICE</td>
                            </tr>
                            <tr class="trheight">
                            ...
                            <tr>
                                ...
                                <td class="qno" style="vertical-align: top; background-color: #d9d3d3;" width="35%">
                                    <table border="0" width="100%" class="quotation">
                                        <tr>
                                            <td class="" style="vertical-align: top; padding: 1px 5px; width: 38%">Invoice Date</td>
                                            <td class="" style="width: 2%; vertical-align: top; padding: 1px 5px;">:</td>
                            ...
                            <%--  <tr>
                                <td class="qno" width="100%">
                                    <table border="0" width="100%" class="">
                                        <tr>
                                            <td class="" style="background-color: #e31e24; color: white; text-align: center;">If you have any Question about this Invoice, Please Contact Mr. Das at +91 9674897316 or email at info@aminruptechnologies.co.in</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>--%>
