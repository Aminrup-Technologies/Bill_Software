<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quotation.aspx.cs" Inherits="Bill_Software.corporate.business.print.Quotation" %>
...
<body>
    ...
    <div id="printable" style="width:844px;">
        ...
        <table style="width: 844px;">
                <thead align="left" style="display: table-header-group">
                    <tr>
                        <th>
                            <table style='width: 844px;'>
                                <tr>
                                    <td id="Hederprint" runat="server" style="width: 100%; vertical-align: middle">
                                       <asp:Image ID="Image21" runat="server" Width="844px" Height="106px" ImageUrl="~/corporate/business/WebImages/i2i_lh.jpg" />
                                    </td>
                                </tr>
                            </table>
                        </th>
                ...
                <tbody>
                    <tr>
                        <td style="font: normal 12px/12px Century Gothic; text-align:right; width: 844px;">
                            <span lang="en-us"><span class="style6">&nbsp;</span><span class="style9">QUOTATION</span></span>
                        </td>
                    </tr>

                    <tr>
                        <td style="font: normal 12px/12px Century Gothic; text-align:right; width: 844px;">&nbsp
                        </td>
                    </tr>
                ...
                <td style="text-align:right; width:50%; padding:0px 5px 0px 0px; font:normal 14px/16px Calibri;">
                    &nbsp;</td>
                     ...
                     <tr>
                        <td style="padding:0px 0px 0px 5px; font:normal 14px/16px Calibri; width: 844px;">
                    ...
                    <tr>
                        <td style="padding:0px 0px 0px 5px; font:normal 14px/16px Calibri;width: 844px;">
                            <asp:Label ID="lblcity" runat="server" CssClass="style11"></asp:Label>-<asp:Label ID="lblPin" runat="server" CssClass="style11"></asp:Label>
                        </td>
                     </tr>
                    <tr>
                        <td style="padding:0px 0px 0px 5px; font:normal 14px/16px Calibri; width: 844px;">
                    ...
                    <tr>
                        <td style="border:1px solid #bfbfbf; border-bottom:none; border-right:none;width: 844px;">
                        ...
                        <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table1">
                            <tr>
                                ...
                                <td rowspan="2" bgcolor="#dbe5f1" style="padding:0px 0px 0px 5px;">
                                    <b><span class="style17">Amount (In Words):</span><span lang="en-us"></span><asp:Label ID="lblword" runat="server" Font-Bold="False" CssClass="style22" 
                    ...
                    <tr>
                        <td style="text-align:right; padding:4px 30px 4px 2px; width: 844px;">
                    ...
                    <tr>
                        <td style="text-align:right; padding:4px 7px 4px 2px; width: 844px;">
                ...
                <tfoot align="left" style="display: table-footer-group;" id="print-foot">
                    <tr>
                        <td>
                            <table style='width: 844px;'>
                                <tr>
                                    <td id="footerrprint" style="width: 100%; vertical-align: middle" id="footimg">
                                        <asp:Image ID="Image22" runat="server" Width="844px" Height="100px" ImageUrl="~/corporate/business/WebImages/i2i_lh_b.jpg" />
                                    </td>
                                </tr>
                            </table>
                        </td>
