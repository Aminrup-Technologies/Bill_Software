<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="billduplicate.aspx.cs" Inherits="Bill_Software.corporate.business.print.billduplicate" %>
    ...
    <div id="printable" style="width:844px;">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
          ...
          <%--  <tr>
            ...
            <tr>
                <td class="style5" colspan="2">
                    <span lang="en-us"><span class="style6">&nbsp;</span><span class="style9">TAX INVOICE</span></span></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align:right;font:normal 14px/20px Calibri;">
                    (Original Seller&#39;s Copy)</td>
            </tr>
            <tr>
                <td colspan="2">
                    &nbsp;</td>
           ...
           <%-- <tr>
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" class="tableOne" runat="server" id="gst_value">
                         <tr>
                             <td>
                                    Client GST NO. <asp:Label ID="lblgstno" runat="server"></asp:Label>
                             </td>
                         </tr>
                    </table>
                </td>
           ...
           <%-- <tr>
                     ...
                     <HeaderTemplate>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1">
                                <tr>
                                    ...
                                    <td style="width:10%;text-align:center; font:arial;"><asp:Label runat="server" ID="Label3" Text="Tax/Vat" Font-Bold="true" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label></td>
                ...
                <table cellpadding="0" cellspacing="0" width="100%";>
                        ...
                        <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table1">
                            ...
                            <tr>
                                <td rowspan="3" bgcolor="#dbe5f1" style="padding:0px 0px 0px 5px;">
                                    <b><span class="style17">Total Amount Due (In Words):</span><span lang="en-us"> </span><asp:Label ID="lblword" 
                     ...
                     <tr>
                                ...
                                <td width="15%" 
                                    style=" border-right:1px solid #bfbfbf; border-left:1px solid #bfbfbf; border-bottom:1px solid #bfbfbf;text-align:right; padding:0px 20px 0px 2px; text-align:right; padding:0px 20px 0px 2px;" 
                                    class="style7">
                                    <asp:Label ID="lblpayment" runat="server" CssClass="style17" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label>
                                </td>
                            </tr>
                     <tr>
                                <td width="55%">
                                ...
                                <td width="15%" 
                                    style=" border-right:1px solid #bfbfbf; border-left:1px solid #bfbfbf; border-bottom:1px solid #bfbfbf;text-align:right; padding:0px 20px 0px 2px; text-align:right; padding:0px 20px 0px 2px;" 
                                    class="style7">
                                    <asp:Label ID="lbldue" runat="server" CssClass="style17" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <tr>
                <td colspan="2">
                    <strong>Payment Received</strong></td>
            </tr>
            <tr>
                <%--<td style="width:10%;text-align:center; font:arial;"><asp:Label runat="server" ID="Label6" Text="Rate With Tax" Font-Bold="true" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label></td>--%>
                <td colspan="2">
                            ...
                            <table>
                                <tr>
                                    <td style="font-family: Arial; font-size: small;">
                                        <asp:Label ID="Label1000" runat="server" Text="Rs. "></asp:Label>
                                    </td>
                                    <td style="font-family: Arial; font-size: small;">
                                        <asp:Label ID="Label100" runat="server" Text='<%# Eval("Given_amount") %> '></asp:Label>
                                    </td>
                                    <td style="font-family: Arial; font-size: small;">
                                        <asp:Label ID="Label9" runat="server" Text=","></asp:Label>
                                    </td>
                                    <td style="font-family: Arial; font-size: small;">
                                        <asp:Label ID="Label200" runat="server" Text='<%# Eval("type") %> '></asp:Label>
                                    </td>
                                    <td style="font-family: Arial; font-size: small;">
                                        <asp:Label ID="Label300" runat="server" Text='<%# Eval("Ch_no") %>'></asp:Label>
                                    </td>
                                    <td style="font-family: Arial; font-size: small;">
                                        <asp:Label ID="Label400" runat="server" Text='<%# Eval("Ch_date") %>'></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
            ...
            <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="tableTwo">
                        <tr>
                            <td style="width:50%">
                                A/C Name: Aminrup Technologies</td>
                            <td style="width:50%;">
                                <span lang="en-us">Bank: </span>ICICI<span lang="en-us"> BANK, A/C No-</span>012805007421</td>
                        </tr>
                        <tr>
                            <td style="width:50%">
                                Branch: Sakchi, Jamshedpur-831001</td>
                            <td style="width:50%;"> IFSC Code: ICIC0000001</td>
                        </tr>
