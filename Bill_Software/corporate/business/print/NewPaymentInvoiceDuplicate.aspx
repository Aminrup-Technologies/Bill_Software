<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPaymentInvoiceDuplicate.aspx.cs" Inherits="Bill_Software.corporate.business.print.NewPaymentInvoiceDuplicate" %>
                    ...
                    <td id="bodycontain" width="100%" style="font-weight: bold">
                        ...
                        <table border="0" width="100%">
                           ...
                           <tr>
                            ...
                            <tr class="trheight">
                               <td class="sub" style="text-align: right; font-weight: bold;  font-size: 15px;">Original Seller's Copy</td>
                            </tr>
                            <tr>
                                <td class="gap" style="text-align: center; font-weight: bold;">&nbsp</td>
                            </tr>
