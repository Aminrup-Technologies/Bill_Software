    ...
    public partial class NewInvoice : System.Web.UI.Page
    {
        ...
        private void Buindamount()
        {
            ...
            else
            {
                ...
                string cmdstring = "select Product_id as HSN,(Product_name+' '+specification) as Product_name,Quantity,sail_rate,Service_tax_rate,Total_sail_rate1,Total_sail_rate2 from  tbl_Invoice_details where Quotation_no=@Quotation_no and  Invoice_No=@Invoice_No order by Product_name";
                SqlParameter[] pram = {
                                          new SqlParameter("@Quotation_no",lblqnumber.Text),
