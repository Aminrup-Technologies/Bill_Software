...
{
    public partial class NewPaymentInvoice : System.Web.UI.Page
    {
        ...
        public string lblSubtotal = "", lblstax = "", lblstax0 = "", lblnetamount = "", lbldue = "", lbldiscount="", lblword="", lblpayment="";
        public int TQ = 0;
        ...
        private void buindpaymentdetails(string iddetails, string invno)
        {
            ...
            if (rdrprepayment.HasRows)
            {
                ...
                {
                    string fds = "";
                    if (rdrprepayment["type"].ToString() == "Online Fund Transfer")
                    {
                        fds = "Payment of Rs "+ rdrprepayment["Given_amount"].ToString() + " Recieved, Transaction Reference Id: "+ rdrprepayment["Ch_no"].ToString() +" "+ rdrprepayment["Ch_date"].ToString() + ", " + rdrprepayment["Ch_bank"].ToString() + "";
                    }
