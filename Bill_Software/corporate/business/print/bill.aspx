<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bill.aspx.cs" Inherits="Bill_Software.corporate.business.print.bill" %>
            ...
            <%--<tr>
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" class="tableOne" runat="server" id="gst_value">
                         <tr>
                             <td>
                                    Client GST NO. <asp:Label ID="lblgstno" runat="server"></asp:Label></td>
                         </tr>
                    </table>
                </td>
            </tr>--%>
            ...
            <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="tableTwo">
                        <tr>
                            ...
                            <td style="width:50%;">
                                <span lang="en-us">Bank: </span>ICICI<span lang="en-us"> BANK, A/C No-</span>032658457861</td>
                        </tr>
                        <tr>
                            <td style="width:50%">
                                Branch:
