<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationHydrent.aspx.cs" Inherits="Bill_Software.corporate.business.print.QuotationHydrent" %>
...
<body>
    ...
    <div id="printable" style="width:844px;">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
            ...
            <tr>
                <td class="style5" colspan="2">
                    <span lang="en-us"><span class="style6">&nbsp;</span><span class="style9">QUOTATION</span></span></td>
            </tr>
            <tr>
                <td colspan="2">
                    &nbsp;</td>
                ...
                <td colspan="2" style="border:1px solid #bfbfbf;">
                    <asp:DataList ID="DataList1" runat="server" Width="100%" >
                     <HeaderTemplate>
                        ...
                        <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table1">
                            <tr>
                                <td style="width:8%;border-top:none; text-align:center; font:arial;"><asp:Label ID="qtation_survice" runat="server" Text='<%# Eval("Product_id") %>' style="font-family: Arial; font-size: small;"></asp:Label></td>
                                ...
                                <td style="width:10%;border-top:none;  text-align:right; padding:0px 20px 0px 2px; font:arial;">
                                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("base_rate") %>' style="font-family: Arial; font-size: small; text-align:center;"></asp:Label>
                                ...
                                <td style="width:15%;border-top:none; text-align:right; padding:0px 20px 0px 2px; font:arial;"><asp:Label ID="Label2" runat="server" Text='<%# Eval("total_amount") %>' style="font-family: Arial; font-size: small;"></asp:Label></td>
                            </tr>
                            </table>
                        </ItemTemplate>
                    </asp:DataList>
                ...
                <table cellpadding="0" cellspacing="0" width="100%";>
                            ...
                            <tr>
                                ...
                                <td width="30%" style="width: 45%;" 
                                    ...
                                    <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table1" style="font-weight:bold">

                                        <asp:Label ID="lblvatamo" runat="server" ></asp:Label>
                                    </table>
                                    </td>
                                <tr>
                                ...
                                <td style=" border-right:1px solid #bfbfbf; border-left:1px solid #bfbfbf; border-bottom:1px solid #bfbfbf;text-align:right; padding:0px 20px 0px 2px;" 
                                    ...
                                    <span class="style10"><span class="style18"><asp:Label ID="lblstax0" runat="server" style="font-family: Arial; font-size: small;"></asp:Label>
