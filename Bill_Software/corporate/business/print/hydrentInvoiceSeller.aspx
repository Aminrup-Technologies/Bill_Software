<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hydrentInvoiceSeller.aspx.cs" Inherits="Bill_Software.corporate.business.print.hydrentInvoiceSeller" %>
                     ...
                     <HeaderTemplate>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table1">
                                <tr>
                                        ...
                                        <td style="width:47%;text-align:center; font:arial;"><asp:Label  ID="no_of_sur" runat="server"  Text="Particulars" Font-Bold="true" style="font-family: Arial; font-size: small; font-weight:bold;"></asp:Label></td>
            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%";>
                            ...
                            <tr>
                                <td width="55%">
                                    &nbsp;</td>
                                <td width="30%" style="width: 45%;" colspan="2">

                                      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table1" style="font-weight:bold">

                                        <asp:Label ID="lblvatamo" runat="server" CssClass="style17" style="font-family: Arial; font-size: small;"></asp:Label>
            ...
            <tr>
                <td colspan="2" style="text-align:right; padding:4px 30px 4px 2px;">
                    <span lang="en-us">&nbsp;<asp:Image ID="Image4" runat="server" 
                        Height="73px" Width="133px" ImageUrl="~/corporate/business/WebImages/Stamp.jpg" />
                        </span>&nbsp;</td>
            </tr>
