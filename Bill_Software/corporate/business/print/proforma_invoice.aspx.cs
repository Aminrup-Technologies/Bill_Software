...
{
    public partial class proforma_invoice : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                if (dtp.Rows.Count > 0)
                {
                    ...
                    if (Session["cgstOrsgstp"].ToString() == "YES")
                    {
                        ...
                        strp += "<td class='tdsty' style='text-align:right; padding:2px 0px 2px 0px; width:9%; font-size:13px;border:1px solid #bfbfbf; border-right:none; border-top:none; font-weight:bold'>" + TOTALCGST.ToString() + "</td>";
                        ...
                        strp += "<td class='tdsty' style='text-align:left; padding:5px 0px 5px 15px; width:10%; font-size:13px;border:1px solid #bfbfbf;border-top:none;font-weight:bold'>" + grandtotal.ToString() + "</td>";
                        strp += "</tr>";
                        strp += "</table>";
                    ...
                    if (Session["igstp"].ToString() == "YES")
                    {
                        ...
                        strp += "<td class='tdsty' style='text-align:left; padding:5px 15px 5px 15px; width:10%; font-size:13px;border:1px solid #bfbfbf;border-top:none;font-weight:bold'>" + grandtotal.ToString() + "</td>";
                        strp += "</tr>";
                        strp += "</table>";
                    }
