...
{
    public partial class hydrentInvoice : System.Web.UI.Page
    {
        ...
        {
            if (!AuthGuard.EnsurePrint(this, "tbl_HydrentInvoice.ID", Request.QueryString["ID"])) return;
        ...
        private void binddata(object quotano, string vatper)
        {
