...
{
    internal sealed class PurchaseOrderPrintHelper
    {
        private readonly Page page;
        private readonly CultureInfo cultureInfo;

        public PurchaseOrderPrintHelper(Page page)
        {
            this.page = page;
        ...
        private Control FindDeep(string id)
        {
            return FindDeep(page, id);
        }

        private static Control FindDeep(Control root, string id)
        {
            if (root == null || string.IsNullOrEmpty(id)) return null;
            if (root.ID == id) return root;
            foreach (Control child in root.Controls)
            {
                Control found = FindDeep(child, id);
                if (found != null) return found;
            }
            return null;
        }

        private Label Lbl(string id)
        {
            return FindDeep(id) as Label;
        }

        private Label lblqnumber { get { return Lbl("lblqnumber"); } }
        private Label lbldate { get { return Lbl("lbldate"); } }
        private Label lblClientCode { get { return Lbl("lblClientCode"); } }
        private Label Label2 { get { return Lbl("Label2"); } }
        private Label Label1 { get { return Lbl("Label1"); } }
        private Label lbl_ponumber { get { return Lbl("lbl_ponumber"); } }
        private Label lbl_podate { get { return Lbl("lbl_podate"); } }
        private Label lbl_donumber { get { return Lbl("lbl_donumber"); } }
        private Label lbl_refname { get { return Lbl("lbl_refname"); } }
        private Label lbl_refid { get { return Lbl("lbl_refid"); } }
        private Label lbl_refdate { get { return Lbl("lbl_refdate"); } }
        private HtmlTableRow Tr2 { get { return FindDeep("Tr2") as HtmlTableRow; } }
        private Label lbl_deliverytrms { get { return Lbl("lbl_deliverytrms"); } }
        private Label lbl_pkging { get { return Lbl("lbl_pkging"); } }
        private Label lbl_remarks { get { return Lbl("lbl_remarks"); } }
        private Label lbl_valdays { get { return Lbl("lbl_valdays"); } }
        private Label lblplaceofsup1 { get { return Lbl("lblplaceofsup1"); } }
        private Label lblplaceofsup2 { get { return Lbl("lblplaceofsup2"); } }
        private Label lblplaceofsup3 { get { return Lbl("lblplaceofsup3"); } }
        private Label lblProductDetails { get { return Lbl("lblProductDetails"); } }
        private Label lblPrimaryServicePoint { get { return Lbl("lblPrimaryServicePoint"); } }
        private Label lblserviceamo { get { return Lbl("lblserviceamo"); } }
        private Label lblPayment { get { return Lbl("lblPayment"); } }
        private Label lblPanno { get { return Lbl("lblPanno"); } }
        private Label lblGstno { get { return Lbl("lblGstno"); } }
        private Label lblClient { get { return Lbl("lblClient"); } }
        private Label txtaddres { get { return Lbl("txtaddres"); } }
        private Label lblcity { get { return Lbl("lblcity"); } }
        private Label lblpincode { get { return Lbl("lblpincode"); } }
        private Label lblrename { get { return Lbl("lblrename"); } }
        private Label lbltital { get { return Lbl("lbltital"); } }
        private Label lbllname { get { return Lbl("lbllname"); } }
        private Label lbldeg { get { return Lbl("lbldeg"); } }
        private Label lblservice { get { return Lbl("lblservice"); } }
        private Label lblPrimaryService { get { return Lbl("lblPrimaryService"); } }
        ...
        private void buindalldata(string id)
        {
            ...
            if (dtmain.Rows.Count > 0)
            {
                ...
                if (recordType == "Purchase Order")
                {
                    ...
                    Control lblValDays = FindDeep("lbl_valdays");
                    if (lblValDays != null) lblValDays.Visible = false;

                    Control lblValDefaultText = FindDeep("lbl_val_default_text");
                    if (lblValDefaultText != null) lblValDefaultText.Visible = false;

                    Control lblValDaysText = FindDeep("lbl_val_days_text");
                    ...
                    Label lblValDates = (Label)FindDeep("lbl_val_dates");
                    if (lblValDates != null)
                    {
            ...
            {
                page.Response.Write("Purchase Order Not Found.");
                page.Response.End();
            }
        }
        ...
        private void Bindclientdetails(string clientid)
        {
            ...
            if (dtClient.Rows.Count > 0)
            {
                ...
                Control lblContactControl = FindDeep("lblContact");
