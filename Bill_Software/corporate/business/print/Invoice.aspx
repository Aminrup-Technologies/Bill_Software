<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="Bill_Software.corporate.business.print.Invoice" %>
   ...
   <div id="printable" style="width:844px;">
        ...
        <table cellpadding="0" cellspacing="0" class="style1">
           ...
           <%-- <tr>
            ...
            <tr>
                <td colspan="2" style="padding:0px 0px 0px 5px; font:normal 14px/16px Calibri;">
                    <asp:Label ID="lblClientVat" runat="server" CssClass="style11"></asp:Label></td>
            </tr>
