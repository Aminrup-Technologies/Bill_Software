    ...
    <form id="form1" runat="server">
        <div id="printable" style="width: 844px;">
            ...
            <table cellpadding="0" cellspacing="0" class="style1">
                ...
                <tr>
                    <td></td>
                    <td style="text-decoration: underline; font-weight: bold; font-size: 16px;">PURCHASE REQUISITION
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; padding: 0px 0px 0px 5px; font: normal 14px/16px Calibri;">&nbsp;</td>
                    <td style="text-align: right; width: 50%; padding: 0px 5px 0px 0px; font: normal 14px/16px Calibri;">Date:
                        <asp:Label ID="lbldate" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="style11" style="padding: 0px 0px 0px 5px; font: normal 14px/16px Calibri;">Company Name:
                        <asp:Label ID="lblcompanyName" runat="server"></asp:Label>
                    </td>
                </tr>

                <tr>
                    <td colspan="2" style="padding: 0px 0px 0px 5px; font: normal 14px/16px Calibri;">Company Address:
                ...
                <tr>
                    <td colspan="2" style="">
                        ...
                        <table cellpadding='0' cellspacing='0' class='style1'>
                            <tr>
                                <td class='tdsty' style='text-align: left; padding: 3px 15px 3px 15px; width: 60%; font-size: 13px; border: 0px; font-weight: bold;' colspan='6'>Cheque No:
                        ...
                        <table cellpadding='0' cellspacing='0' class='style1'>
                            <tr>
                                <td class='tdsty' style='text-align: left; padding: 3px 15px 3px 15px; width: 60%; font-size: 13px; border: 0px; font-weight: bold;' colspan='6'>Issue Date:
                        ...
                        <table cellpadding='0' cellspacing='0' class='style1'>
                            <tr>
                                <td class='tdsty' style='text-align: left; padding: 3px 15px 3px 15px; width: 60%; font-size: 13px; border: 0px; font-weight: bold;' colspan='6'>Bank:
                        ...
                        <table cellpadding='0' cellspacing='0' class='style1'>
                            <tr>
                                <td class='tdsty' style='text-align: left; padding: 3px 15px 3px 15px; width: 60%; font-size: 13px; border: 0px; font-weight: bold;' colspan='6'>IFS Code:
                                    <asp:Label ID="lblIFSCode" runat="server"></asp:Label></td>
                                <td class='tdsty' style='text-align: right; padding: 5px 15px 5px 0px; width: 19.5%; font-size: 13px; border: 0px; font-weight: bold' colspan='4'></td>
                                <td class='tdsty' style='text-align: right; padding: 5px 12px 5px 0px; width: 20.5%; font-size: 13px; border: 0px; border-top: none; font-weight: bold'></td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td colspan="2" class="style16" style="text-align: right; padding: 4px 7px 4px 2px;">HR & ADMIN</td>
                </tr>
