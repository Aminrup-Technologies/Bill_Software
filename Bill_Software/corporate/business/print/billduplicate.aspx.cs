...
namespace Bill_Software.corporate.business.print
{
    public partial class billduplicate : System.Web.UI.Page
    {
        ...
        private void bindcgstorigst(string qno)
        {
            ...
            {
                Session["cgstOrsgstbd"] = dtci.Rows[0]["cgstOrsgst"].ToString();
                Session["igstbd"] = dtci.Rows[0]["igst"].ToString();
            }
        }
        ...
        private void Buindamount()
        {
            ...
            else
            {
                ...
                if (dtp.Rows.Count > 0)
                {
                    ...
                    if (Session["cgstOrsgstbd"].ToString() == "YES")
                    {
                        double TOTALCGST = 0;
                        double SUBTOTAL = 0;
                        double TOTALGST = 0;
                    ...
                    if (Session["igstbd"].ToString() == "YES")
                    {
