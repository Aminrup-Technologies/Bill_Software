...
<body>
  ...
  <tr>
	...
	<h2 style="font:normal 24px/36px Arial, Helvetica, sans-serif; color:#999;">
		<asp:Image ID="Image2" runat="server"
			ImageUrl="~/corporate/business/WebImages/oh4ylogo.jpg" Height="82px" Width="245px"/>
		</h2>
...
&nbsp;</td>
		...
		<td width="53%" align="left" valign="middle"><asp:TextBox ID="txtUserName" runat="server" class="textbox_style"></asp:TextBox>
												</td>
		</tr>
		<tr>
		<td align="right" valign="middle"><strong style="color:#333;"> Password</strong></td>
		<td align="left" valign="middle">&nbsp;</td>
		<td align="left" valign="middle"><asp:TextBox ID="txtPassword" runat="server"
	...
	<td width="57%" height="437" style="text-align:center;">
		...
		<asp:Image ID="Image4" runat="server" Height="102px" ImageUrl="~/corporate/business/WebImages/oh4y.png"  Width="163px" />
		<br />
		<br />
		<br />
		<p >Do not attempt to login unless you are an authorised user.</p>
		<p >
			Your IP Address :<asp:Label ID="lblIP" runat="server" Font-Bold="True"></asp:Label> &nbsp;& Computer Name :<asp:Label ID="lblpcname" runat="server" Font-Bold="True"></asp:Label> &nbsp;will be recorded.</p>
								<p >
									&nbsp;</p>
								<p >
									<b><sup>©</sup></b>
									<asp:Image ID="Image3" runat="server" ImageUrl="~/corporate/business/WebImages/oh4y.png" Width="25px" Height="16px" /> &nbsp;<sup>2020-2021</sup></p>
								<p >
									&nbsp;</p>
							</td>
	<td width="4%">
