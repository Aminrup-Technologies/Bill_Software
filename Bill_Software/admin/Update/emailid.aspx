<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emailid.aspx.cs" Inherits="Bill_Software.Update.emailid" %>
        ...
        <table cellpadding="0" cellspacing="1" class="style1">
            ...
            <tr>
                <td class="style5" colspan="2">
                    <asp:Button ID="btnUpdate" class="btn_style" runat="server" Text="Update" onclientclick="return ValidateEmail();" onclick="btnUpdate_Click" CssClass="btn_style" />
                </td>
            </tr>
            <tr>
                <td>
