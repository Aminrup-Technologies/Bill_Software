<%@ Page Title="" Language="C#" MasterPageFile="~/admin/card.Master" AutoEventWireup="true" CodeBehind="Upload_data.aspx.cs" Inherits="Bill_Software.admin.WebForm6" %>
    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        ...
        <tr>
            ...
            <td width="25%" colspan="2" style="width: 50%; text-align: center">
                <asp:Button ID="Button1" runat="server" CssClass="btn_style" OnClick="Button1_Click" Text="Upload" onclientclick="return ValidateField();"/>
            </td>
            <td width="25%">
                &nbsp;</td>
        </tr>
