<%@ Page Title="" Language="C#" MasterPageFile="~/admin/card.Master" AutoEventWireup="true" CodeBehind="show_date.aspx.cs" Inherits="Bill_Software.admin.WebForm3" %>
    ...
    <table cellpadding="0" cellspacing="1" class="style1">
        ...
        <tr>
            ...
            <td width="25%" colspan="2" style="width: 50%; text-align: center">
                <asp:Button ID="Button1" runat="server" CssClass="btn_style" OnClick="Button1_Click" Text="Search" onclientclick="return ValidateField();"/>
            </td>
            <td width="25%">
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center">
                ...
                <asp:Image ID="Image2" runat="server" Height="49px" 
                    ...
                    ToolTip="Print ID Card.." Visible="False" Width="55px" />
            <td>
                &nbsp;</td>
        </tr>
        <tr>
