...
6. Refresh the census with `python3 docs/page-catalog/_generate.py`. Text after `<!-- NARRATIVE:BEGIN -->` in each `DOMAIN_*.md` is kept. One-line quirks live in `_generate.py` (`UNIQUE_NOTES`).
