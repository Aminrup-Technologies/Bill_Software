...
Canonical current facts: [`DOMAIN_sales-visit.md`](../page-catalog/DOMAIN_sales-visit.md), leftover pointers [`docs/06`](../06_Sales_Visit_Planner.md) / [`docs/07`](../07_Sales_Visit_Reporting.md), mailers [`docs/11`](../11_Communications.md), SP index [`SHARED_RUNTIME.md`](../page-catalog/SHARED_RUNTIME.md), live UAT schema [`SHARED_SCHEMA.md`](../page-catalog/SHARED_SCHEMA.md).
...
|----|----------------|--------------|
| **D-01** | Visit INSERT omits `CompanyID` | **Remediating (forward).** `daily_rpt` INSERT and planner follow-up INSERT set `@CompanyID`. On **`flamex_uat`** the column is `int NOT NULL DEFAULT (1)`: **78 visits, 0 NULL, all CompanyID=1**. Historical-NULL leftover is not in this UAT copy; it can still exist on an older live backup. |
| **D-03** | `CreatedByCode` fallback `"FLM03"` | **Still live** in `daily_rpt.aspx.cs`. UAT has **2** rows with `CreatedByCode='FLM03'`. |
